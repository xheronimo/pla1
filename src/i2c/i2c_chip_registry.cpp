...
{
    { I2CDevice::ADS1115, ads1115Detect, ads1115Init, ads1115ReadSignal, ads1115GetMetadata, true },
    { I2CDevice::INA219,  ina219Detect,  ina219Init,  ina219ReadSignal,  ina219GetMetadata,  true },
    { I2CDevice::SHT31,   sht31Detect,   sht31Init,   sht31ReadSignal,   sht31GetMetadata,   true },
    { I2CDevice::ENS160,  ens160Detect,  ens160Init,  ens160ReadSignal,  ens160GetMetadata,  true },
    { I2CDevice::BME280,  bme280Detect,  bme280Init,  bme280ReadSignal,  bme280GetMetadata,  true },
    { I2CDevice::BH1750,  bh1750Detect,  bh1750Init,  bh1750ReadSignal,  bh1750GetMetadata,  true },
    { I2CDevice::CCS811,  ccs811Detect,  ccs811Init,  ccs811ReadSignal,  ccs811GetMetadata,  true },

    // Expansores fijos de placa → NO autodetect
    { I2CDevice::PCF8574, pcfDetect8574, pcfInit, pcfReadSignal, pcf8574GetMetadata, false },
    { I2CDevice::PCF8575, pcfDetect8575, pcfInit, pcfReadSignal, pcf8575GetMetadata, false },
};
