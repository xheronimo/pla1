...
void webInit()
{
    ...
    server.on("/api/i2c/status", HTTP_GET, handleApiI2CStatus);

    registerI2CScanAPI();
    registerI2CCreateAPI();
    registerI2CDriversAPI();
    registerI2CHealthAPI();
    registerHealthApi();
    registerModbusHealthApi();
    registerSystemHealthAPI();
    registerWatchdogHealthAPI();
    registerSystemResetAPI();
    registerSystemBootApi();
    registerSignalApi();
    registerAlarmsApi();
    registerSystemResetApi();
